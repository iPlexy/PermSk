...
public class ExprPlayerPrefix extends SimpleExpression<String> {
    ...
    static {
        Skript.registerExpression(ExprPlayerPrefix.class, String.class, ExpressionType.PROPERTY,
                "[permsk] prefix of [player] %offlineplayer% [in [world] %-world%]",
                "[permsk] [player] %offlineplayer%'s prefix [in [world] %-world%]");
    }
    ...
    public String toString(Event e, boolean d) {
        return "Prefix of player " + player.toString(e, d);
    }
